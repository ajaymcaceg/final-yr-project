...
const FormPDFGenerator = ({ data }) => {
  ...
  return (
    <div>
      ...
      >
        <h1 style={{ marginBottom: "20px" }}>Form Data</h1>
        ...
        >
          ...
          <p>
            <strong>Course Teaching:</strong> {data.designation?.courseTeaching}
          </p>
          <p>
          ...
          {data.facultyPublication &&
            data.facultyPublication.map((publication, index) => (
              <div key={index}>
                ...
                <p>
                  <strong>Books Published:</strong> {publication.booksPublished}
                </p>
                <p>
